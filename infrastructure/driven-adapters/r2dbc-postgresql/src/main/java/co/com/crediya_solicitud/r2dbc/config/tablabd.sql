...
-- Insertar estado "Pendiente de revisión"
INSERT INTO estados (state_id, name, description) VALUES
    ('estado-001', 'Pendiente de revisión', 'La solicitud está pendiente de ser revisada');

-- Insertar tres tipos de préstamo
INSERT INTO tipo_prestamo (loan_type_id, name, minimum_amount, maximum_amount, interest_rate, automatic_validation) VALUES
('prestamo-001', 'Crédito Personal', 1000.00, 10000.00, 12.50, TRUE),
